...
-- CreateIndex
CREATE UNIQUE INDEX "users_twilioIdentity_key" ON "users"("twilioIdentity");
...
-- CreateIndex
CREATE INDEX "participants_identity_idx" ON "participants"("identity");

-- CreateIndex
CREATE UNIQUE INDEX "participants_conversationId_userId_key" ON "participants"("conversationId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "participants_conversationId_identity_key" ON "participants"("conversationId", "identity");
